========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet SimulateurDAgglomerateur
========================================================================

AppWizard a créé cette application SimulateurDAgglomerateur pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application SimulateurDAgglomerateur.


SimulateurDAgglomerateur.vcxproj
...
SimulateurDAgglomerateur.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) SimulateurDAgglomerateur.pch et un fichier de type précompilé nommé StdAfx.obj.
